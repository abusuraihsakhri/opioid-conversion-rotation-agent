"""
Automated Pytest for opioid-conversion-rotation-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    IvtooralConversionTableEngine,
    IncompleteCrosstoleranceDoseReductionEngine,
    MethadoneSpecialProtocolEngine,
    BreakthroughPainCalculator,
    OpioidinducedConstipationOicProphylaxisEngine,
    RespiratoryDepressionRiskScoringEngine,
    OpioidconversionrotationagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = OpioidconversionrotationagentEnrichmentSuite()
